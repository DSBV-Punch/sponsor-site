			...
			<div className="container relative mx-auto text-center">
				<div className="max-w-2xl mx-auto">
					...
					<p className="mt-6 text-lg text-gray-700 mb-8">
						Help our exceptional team of student-athletes represent TU Delft at
						the European University Championship. Your support empowers women in
						STEM and sports while gaining international brand exposure.
					</p>
					{/* CTA Buttons */}
