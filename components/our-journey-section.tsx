		...
		<section className="w-full bg-white py-20 px-4">
			<div className="max-w-4xl mx-auto text-center">
				...
				<p className="text-gray-700 text-lg md:text-xl mb-4">
					We are the women’s basketball team of Delft University of Technology,
					proudly representing Punch in both national competitions and student
					tournaments.
				</p>
				<p className="text-gray-700 text-lg md:text-xl mb-8">
					In 2024, our hard work paid off when we became Dutch Student Champions
					at GNSK in Rotterdam — earning us a place at the{" "}
			...
			<div className="max-w-5xl mx-auto mt-10 grid gap-8 md:grid-cols-3 text-center">
				...
				<div className="flex flex-col items-center">
					...
					<p className="text-gray-600 mt-2">
						We took the title at the National Student Championships in Rotterdam
						🏆 — securing our EUC spot.
					</p>
				</div>
